...
|-----------------------------------------|-----------------------------------------|---------------------------------|
| Python, R, Elixir, JavaScript | SQL, AWS Athena/Redshift/Glue, Elasticsearch, OpenStack Swift | Virtualization (ESXi), EC2/Droplets/Azure, Anaconda, Pyspark, Pandas, Tensorflow, Jetpack 6, OpenCV, Torchmetrics|
