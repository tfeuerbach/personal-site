...
Team-oriented analytical thinker, seeking to combine cross-discipline interests in statistical data analytics, machine learning, and economics to drive data-driven solutions and insights.

### Skills

| Languages                                     | Database/Data Retrieval            | Platforms              |
|-----------------------------------------------|------------------------------------|------------------------|
| Python, R, JavaScript, Elixir, Ruby, HTML/CSS | SQL, AWS Athena/Redshift/Glue, SAP | Linux, Mac OS, Windows |
